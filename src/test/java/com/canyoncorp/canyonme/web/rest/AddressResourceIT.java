...
class AddressResourceIT {
    ...
    private static final String DEFAULT_COMPLIMENT_1 = "AAAAAAAAAA";
    private static final String UPDATED_COMPLIMENT_1 = "BBBBBBBBBB";

    private static final String DEFAULT_COMPLIMENT_2 = "AAAAAAAAAA";
    private static final String UPDATED_COMPLIMENT_2 = "BBBBBBBBBB";
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address()
            ...
            .compliment1(DEFAULT_COMPLIMENT_1)
            .compliment2(DEFAULT_COMPLIMENT_2)
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address()
            ...
            .compliment1(UPDATED_COMPLIMENT_1)
            .compliment2(UPDATED_COMPLIMENT_2)
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getCompliment1()).isEqualTo(DEFAULT_COMPLIMENT_1);
        assertThat(testAddress.getCompliment2()).isEqualTo(DEFAULT_COMPLIMENT_2);
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].compliment1").value(hasItem(DEFAULT_COMPLIMENT_1)))
            .andExpect(jsonPath("$.[*].compliment2").value(hasItem(DEFAULT_COMPLIMENT_2)))
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.compliment1").value(DEFAULT_COMPLIMENT_1))
            .andExpect(jsonPath("$.compliment2").value(DEFAULT_COMPLIMENT_2))
    ...
    void putNewAddress() throws Exception {
        ...
        assertThat(testAddress.getCompliment1()).isEqualTo(UPDATED_COMPLIMENT_1);
        assertThat(testAddress.getCompliment2()).isEqualTo(UPDATED_COMPLIMENT_2);
