...
class EmployeeResourceIT {
    ...
    private static final Role DEFAULT_ROLE = Role.STOCK_MANAGER;
    private static final Role UPDATED_ROLE = Role.ORDER_PREPARATOR;
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().role(DEFAULT_ROLE);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().role(UPDATED_ROLE);
        return employee;
    }
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.role(UPDATED_ROLE);
